		...
		n.extend(h.prototype, {
			init: function () {
				...
				n.fancybox.getInstance() ||
					...
					!n.fancybox.isMobile &&
						...
						(d === o &&
							((i = n('<div style="width:100px;height:100px;overflow:scroll;" />').appendTo(
								'body'
							)),
				...
				if (!(u.isDragging || u.isClosing || (u.isAnimating && u.firstRun))) {
					...
					if (((i = u.firstRun = !Object.keys(u.slides).length), !(p < 2 && !i && u.isDragging))) {
						if (
							...
							(s.isMoved =
								(0 !== l.left || 0 !== l.top) && !s.$slide.hasClass('fancybox-animated')),
							(s.forcedDuration = o),
							n.isNumeric(e)
								? (s.forcedDuration = e)
			...
			getFitPos: function (t) {
				...
				return (
					...
					'image' === t.type
						...
						: 'video' === t.contentType &&
							((a = t.opts.width && t.opts.height ? c / l : t.opts.ratio || 16 / 9),
			...
			isScaledDown: function (t, e) {
				...
				return (
					t !== o && e !== o
						...
						: r &&
							((a = n.fancybox.getTranslate(r)), (a = a.width < s.width && a.height < s.height)),
					a
				);
			},
			canPan: function () {
			...
			setBigImage: function (t) {
				...
				(t.$image = o
					...
					.one('load', function () {
						var n;
						t.$ghost ||
							(e.resolveImageSlideSize(t, this.naturalWidth, this.naturalHeight), e.afterLoad(t)),
			...
			setIframe: function (t) {
				var e,
					...
					s = t.$slide;
				(t.$content = n(
					'<div class="fancybox-content' + (a.preload ? ' fancybox-is-hidden' : '') + '"></div>'
				)
					.css(a.css)
					.appendTo(s)),
			...
			create: function () {
				...
				o.$grid ||
					((o.$grid = e('<div class="' + n + ' ' + n + '-' + o.opts.axis + '"></div>').appendTo(
						a.$refs.container.find(s).addBack().filter(s)
					)),
