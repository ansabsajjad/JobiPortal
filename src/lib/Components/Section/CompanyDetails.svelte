<script>
	...
	import SlickSlider from '../Slider/SlickSlider.svelte';
		...
		<div class="row">
			<div class="col-xxl-3 col-xl-4 order-xl-last">
				<div class="job-company-info ms-xl-5 ms-xxl-0 lg-mb-50">
					<img
						...
						alt=""
						class="lazy-img m-auto logo"
					/>
					<div class="text-md text-dark text-center mt-15 mb-20 lg-mb-10">Adobe Inc.</div>
					<div class="text-center">
						<a href="#!" class="website-btn-two tran3s" target="_blank">Visit our website</a>
					</div>
					...
					<div class="border-top mt-35 lg-mt-20 pt-25">
						...
						<a href="#!" class="btn-ten fw-500 text-white w-100 text-center tran3s mt-25"
							>Send Message</a
						>
					</div>
				</div>
			...
			<div class="col-xxl-9 col-xl-8 order-xl-first">
				<div class="details-post-data me-xxl-5 pe-xxl-4">
					...
					<p>
						Felis eget velit aliquet sagittis id. Massa placerat duis ultricies lacus sed turpis
						tincidunt id. Vel eros donec ac odio tempor orci dapibus ultrices. Ipsum consequat nisl
						vel pretium lectus quam. Dignissim sodales ut eu sem.
					</p>
					<h3>Intro</h3>
					...
					<div class="position-relative">
						...
						<SlickSlider {settings} classes="company-review-slider">
							<div class="item">
								<div class="feedback-block-four">
									<div class="d-flex align-items-center">
										...
										<div class="review-score">
											<span class="fw-500 text-dark">4.7</span> out of 5
										</div>
									</div>
									<blockquote>
										It's a well created theme without much overhead. The created was very responsive
										and helpful.
									</blockquote>
									<div class="d-flex align-items-center">
										<img
											src="/assets/images/assets/img_14.jpg"
											alt=""
							...
							<div class="item">
								<div class="feedback-block-four">
									...
									<blockquote>
										Very impressed with the jobi template. The designs/layouts are modern and
										professional with quaintly..
									</blockquote>
									<div class="d-flex align-items-center">
										<img
											src="/assets/images/assets/img_15.jpg"
											alt=""
											class="author-img rounded-circle"
										/>
										<div class="ms-3">
							...
							<div class="item">
								<div class="feedback-block-four">
									...
									<div class="d-flex align-items-center">
										<img
											src="/assets/images/assets/img_22.jpg"
											alt=""
											class="author-img rounded-circle"
										/>
										<div class="ms-3">
