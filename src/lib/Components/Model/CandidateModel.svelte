					...
					<div class="pt-25 pb-30 ps-4 pe-4">
								...
								<div class="filter-block pb-50 md-pb-20 pt-30">
									<div class="loccation-range-select">
										<div class="d-flex align-items-center">
											<span>Radius: &nbsp;</span>
											<div id="rangeValue">{rangeValue}</div>
											<span>&nbsp;miles</span>
										</div>
										<input
											type="range"
										...
										<div class="salary-slider">
											<div class="price-input d-flex align-items-center pt-5">
												<div class="field d-flex align-items-center">
													<input type="number" class="input-min" bind:value={minValue} readonly />
												</div>
												<div class="pe-1 ps-1">-</div>
												<div class="field d-flex align-items-center">
													<input type="number" class="input-max" bind:value={maxValue} readonly />
												</div>
						...
						<div class="row">
							<div class="col-xl-2 m-auto">
								<a href="#!" class="btn-ten fw-500 text-white w-100 text-center tran3s"
									>Apply Filter</a
								>
							</div>
						</div>
