...
<div class="main-page-wrapper">
	...
	{#if !isPreloading}
		<LazyImageLoader />
		<EmployerDashboardAside activeMenu={'SavedCandidate'} />
								...
								<div class="row gx-1 align-items-center">
									<div class="col-xl-3">
										<div class="position-relative">
											<h4 class="candidate-name mb-0">
												<a href="#!" class="tran3s">Shofie Ana</a>
											</h4>
									...
									<div class="col-xl-3 col-md-4">
										<div class="d-flex justify-content-md-end align-items-center">
											<a
												href="#!"
												class="save-btn text-center rounded-circle tran3s mt-10 fw-normal"
												...
												<ul class="dropdown-menu dropdown-menu-end">
													<li>
														<a class="dropdown-item" href="#!"
															><img
																src="/assets/images/lazy.svg"
																data-src="/assets/images/dashboard/icon/icon_18.svg"
																alt=""
																class="lazy-img"
															/> View</a
														>
													...
													<li>
														<a class="dropdown-item" href="#!"
															><img
																src="/assets/images/lazy.svg"
																data-src="/assets/images/dashboard/icon/icon_19.svg"
																alt=""
																class="lazy-img"
															/> Share</a
														>
													...
													<li>
														<a class="dropdown-item" href="#!"
															><img
																src="/assets/images/lazy.svg"
																data-src="/assets/images/dashboard/icon/icon_20.svg"
																alt=""
																class="lazy-img"
															/> Edit</a
														>
													...
													<li>
														<a class="dropdown-item" href="#!"
															><img
																src="/assets/images/lazy.svg"
																data-src="/assets/images/dashboard/icon/icon_21.svg"
																alt=""
																class="lazy-img"
															/> Delete</a
														>
							...
							<div class="right-side">
								<div class="row gx-1 align-items-center">
									<div class="col-xl-3">
										<div class="position-relative">
											<h4 class="candidate-name mb-0">
												<a href="#!" class="tran3s">Riad Mahfuz</a>
											</h4>
