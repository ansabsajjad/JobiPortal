...
<div class="main-page-wrapper">
	...
	{#if !isPreloading}
		<LazyImageLoader />
		<DashboardAside activeMenu={'Resume'} />
					...
					<div class="row">
						<div class="col-sm-6 d-flex">
							<div
								...
								style="background-image: url(/assets/images/video_post.jpg);"
							>
								<a
							...
							<div class="candidate-portfolio-block position-relative mb-25">
								<a href="#!" class="d-block">
									<img
										...
										data-src="/assets/images/dashboard/portfolio_img_01.jpg"
										alt=""
								...
								<a
									href="#!"
									class="remove-portfolio-item rounded-circle d-flex align-items-center justify-content-center tran3s"
									><i class="bi bi-x"></i></a
								>
							</div>
						...
						<div class="col-lg-3 col-6">
							<div class="candidate-portfolio-block position-relative mb-25">
								<a href="#!" class="d-block">
									<img
										src="/assets/images/lazy.svg"
										data-src="/assets/images/dashboard/portfolio_img_02.jpg"
										alt=""
										class="lazy-img w-100"
									/>
								</a>
						...
						<div class="col-lg-3 col-6">
							<div class="candidate-portfolio-block position-relative mb-25">
								<a href="#!" class="d-block">
									<img
										src="/assets/images/lazy.svg"
										data-src="/assets/images/dashboard/portfolio_img_03.jpg"
										alt=""
										class="lazy-img w-100"
									/>
								</a>
						...
						<div class="col-lg-3 col-6">
							<div class="candidate-portfolio-block position-relative mb-25">
								<a href="#!" class="d-block">
									<img
										src="/assets/images/lazy.svg"
										data-src="/assets/images/dashboard/portfolio_img_04.jpg"
										alt=""
										class="lazy-img w-100"
									/>
								</a>
