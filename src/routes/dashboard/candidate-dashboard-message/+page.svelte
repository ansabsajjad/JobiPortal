<script>
	...
	import DashboardAside from '../../../lib/Components/Dashboard/DashboardAside.svelte';
...
<div class="main-page-wrapper">
	...
	{#if !isPreloading}
		<LazyImageLoader />
		<DashboardAside activeMenu={'Messages'} />
					...
					>
						<div class="compose-new-email-container">
							<div class="new-email-header position-relative">
								<div class="btn-group">
									<a
										...
										role="button"
										aria-expanded="false"
										aria-controls="collapseExample">Cc</a
									>
									<a
										data-bs-toggle="collapse"
										href="#BCC-input"
										role="button"
										aria-expanded="false"
										aria-controls="collapseExample">Bcc</a
									>
								</div>
							...
							<div class="compose-body">
								<textarea
									>Hi, Mary Cooper! Thanks for your invitation for the account manager position for
									you company. I Will back to you soon with all the require documents.</textarea
								>
							</div>
							<!-- /.compose-body -->
							...
							<div class="compose-email-footer d-flex justify-content-between">
								<div class="d-flex align-items-center">
									<div class="insert-file position-relative me-3">
										<img
											...
											data-src="/assets/images/dashboard/icon/icon_32.svg"
											alt=""
											class="lazy-img"
										/>
									...
									<button class="insert-emoji me-3"
										><img
											src="/assets/images/lazy.svg"
											data-src="/assets/images/dashboard/icon/icon_33.svg"
											alt=""
											class="lazy-img"
										/></button
									>
									<div class="insert-file position-relative me-3">
										<img
											src="/assets/images/lazy.svg"
											data-src="/assets/images/dashboard/icon/icon_34.svg"
											alt=""
											class="lazy-img"
										/>
								...
								<div class="d-flex align-items-center">
									<a href="#!" class="delete-mail me-3"
										><img
											src="/assets/images/lazy.svg"
											data-src="/assets/images/dashboard/icon/icon_35.svg"
											alt=""
											class="lazy-img"
										/></a
									>
					...
					<div class="col-lg-8">
						...
						>
							<a href="#!" class="prev-msg"
								><img
									src="/assets/images/lazy.svg"
									data-src="/assets/images/dashboard/icon/icon_26.svg"
									alt=""
									class="lazy-img"
								/></a
							>
							...
							<a href="#!" class="next-msg"
								><img
									src="/assets/images/lazy.svg"
									data-src="/assets/images/dashboard/icon/icon_27.svg"
									alt=""
									class="lazy-img"
								/></a
							>
						...
						<div class="row gx-0">
									...
									<div class="ps-3 pe-3 ps-xxl-4 pe-xxl-4">
										...
										<form action="#" class="search-form mt-20 mb-20">
											...
											<button
												><img
													src="/assets/images/lazy.svg"
													data-src="/assets/images/dashboard/icon/icon_10.svg"
													alt=""
										...
										>
											...
											<button class="filter_btn"
												><span style="background:#FF4545;"></span> Read</button
											>
											<button class="filter_btn"
												><span style="background:#3BDA84;"></span> Unread</button
											>
											<button class="filter_btn"
												><span style="background:#50C0FF;"></span> Primary</button
											>
										</div>
									</div>
									<div class="email-read-panel">
											...
											<div class="email-short-preview position-relative">
												...
												<div class="attached-file-preview d-flex align-items-center mt-15">
													<div class="file d-flex align-items-center me-2">
														<img
															src="/assets/images/lazy.svg"
															data-src="/assets/images/dashboard/icon/icon_28.svg"
															alt=""
															class="lazy-img me-2"
														/>
										...
										<div class="email-list-item ps-3 pe-3 ps-xxl-4 pe-xxl-4 primary selected">
											<div class="email-short-preview position-relative">
												...
												<div class="mail-text">
													Hello, Greeting from Uber. Hope you doing great. I am approcing to you
													for..
												</div>
												<div class="attached-file-preview d-flex align-items-center mt-15">
													<div class="file d-flex align-items-center me-2">
										...
										<div class="email-list-item ps-3 pe-3 ps-xxl-4 pe-xxl-4 read">
											<div class="email-short-preview position-relative">
												...
												<div class="mail-text">
													Hello, We’r the well known Real Estate Inc provide best interior/exterior
													solut...
												</div>
											</div>
											<!-- /.email-short-preview -->
							...
							<div class="col-lg-8">
								<div class="open-email-container pb-40">
									<div
										class="email-header divider d-flex justify-content-between ps-4 pe-4 ps-xxl-5 pe-xxl-5"
									>
										<div class="sender-info d-flex align-items-center">
											<img
												src="/assets/images/lazy.svg"
												data-src="/assets/images/dashboard/logo_02.png"
												alt=""
												class="lazy-img logo"
											/>
											<div class="ps-3">
										...
										<div class="email-info">
											...
											<div class="d-flex align-items-center justify-content-end">
												<button class="delete-email"
													><img
														src="/assets/images/lazy.svg"
														data-src="/assets/images/dashboard/icon/icon_29.svg"
														alt=""
														class="lazy-img"
													/></button
												>
												<button class="reply-email ms-3 me-3"
													><img
														src="/assets/images/lazy.svg"
														data-src="/assets/images/dashboard/icon/icon_30.svg"
														alt=""
														class="lazy-img"
													/></button
												>
									...
									<div class="email-body divider">
										<div class="ps-4 pe-4 ps-xxl-5 pe-xxl-5">
											...
											<p>
												Hello, Greeting from Uber. Hope you doing great. I am approaching to you for
												as our company need a great & talented account manager.
											</p>
											...
											<p>
												After that we need to redesign our landing page because the current one
												doesn't carry any information. If you have any question don’t hesitate to
												contact us.
											</p>
									...
									<div class="email-footer">
										<div class="ps-4 pe-4 ps-xxl-5 pe-xxl-5">
												...
												<div class="d-flex">
													<a href="#!" class="file tran3s d-flex align-items-center mt-10" download>
														...
														>
															<img
																src="/assets/images/lazy.svg"
																data-src="/assets/images/dashboard/icon/icon_31.svg"
																alt=""
																class="lazy-img"
															/>
														</div>
											...
											<div class="compose-new-email-container">
												...
												<div class="compose-body">
													<textarea
														>Hi, Mary Cooper! Thanks for your invitation for the account manager
														position for you company. I Will back to you soon with all the require
														documents.</textarea
													>
												</div>
												<!-- /.compose-body -->
